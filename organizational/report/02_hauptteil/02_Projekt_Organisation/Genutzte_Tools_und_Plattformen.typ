...
Für das dezentrale Identitätsmanagement wurde eine eigene Blockchain-Komponente mit REST-Schnittstelle entwickelt. Diese verwaltet @DID:short:pl, Zugriffsrechte und Transaktionen.

Ein zusätzlicher Block Explorer dient der Visualisierung und Überprüfung von Transaktionsverläufen und Beziehungsstrukturen.
