...
void isr_crypto(void)
{
    ...
    encryption_context *encryption_ctx = (encryption_context *)calloc(1, sizeof(encryption_context)); // pvPortCalloc();
    message_context  *message_ctx = (message_context *)calloc(1, sizeof(message_context)); // pvPortCalloc();
...
psa_status_t generate_ephermal_key_pair(message_context *message_ctx, psa_key_handle_t *ephermal_key_handle)
{
    ...
    message_ctx->der_encoded_ephermal_key = (uint8_t *)calloc(1, ecc_pub_key_length_der_encoded); // pvPortCalloc
...
psa_status_t encrypt_battery_data(encryption_context *encryption_ctx, message_context *message_ctx)
{
    ...
    message_ctx->battery_data_encrypted = (uint8_t *)calloc(1, encrypted_data_size); // pvPortCalloc
