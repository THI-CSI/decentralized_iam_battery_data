...
#define REC_PUB_LENGTH            (65U)              /* key size bytes for receiver public keys*/
...
#define ECC_256_PUB_SIZE          (65U)              /* Size of the data buffer(to store key data) in bytes for ECC*/
...
#define DERIVED_AES_KEY_ID        ((psa_key_id_t) 6)  /* persistent identifier for the key.*/
#define REC_KEY_BITS              (256U)
#define REC_PUB_KEY_BUFFER_LEN    (65U)
